...
export const HEADER_COLORS: any = {
  INDEX: COLORS.purple,
  VALUE: COLORS.purple,
  ...
  MATH: COLORS.blue,
  VECTOR_MATH: COLORS.lightPurple,
  COMBINE_XYZ: COLORS.blue,
  SEPARATE_XYZ: COLORS.blue,

  POINTS: COLORS.green,
  FILLET_CURVE: COLORS.green,
  CURVE_CIRCLE: COLORS.green,
  QUADRILATERAL: COLORS.green,
  BOUNDING_BOX: COLORS.green,
  CUBE: COLORS.green,
  CYLINDER: COLORS.green,
  UV_SPHERE: COLORS.green,
  GRID: COLORS.green,
